...
import com.whirlpool.cooking.ka.databinding.LayoutTextButtonMultilineBinding
 ...
 * @since 05/02/2024
 */
class TextButtonMultiLine : ConstraintLayout {

    @Suppress("PrivatePropertyName")
    private val UNKNOWN_VALUE: Int = -1

    private val binding: LayoutTextButtonMultilineBinding
    ...
    constructor(context: Context) : super(context) {
        binding = LayoutTextButtonMultilineBinding.inflate(LayoutInflater.from(context), this, true)
        setButtonView()
    }
