...
import com.whirlpool.cooking.ka.databinding.ItemSettingsLandingListTileBinding
...
/**
 * File        : android.presenter.customviews.listView.SettingsLandingListViewHolderInterface
 ...
 */
open class SettingsLandingListViewHolderInterface(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val listTileBinding =
                ItemSettingsLandingListTileBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return SettingsLandingListItemViewHolder(listTileBinding)
    }

    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, any: Any) {

        val listItemViewHolder = holder as SettingsLandingListItemViewHolder
    ...
    protected inner class SettingsLandingListItemViewHolder internal constructor(private var itemListTileLayoutBinding: ItemSettingsLandingListTileBinding) :
