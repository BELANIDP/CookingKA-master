...
/**
 * File       : com.whirlpool.cooking.ka.ktn.android.presenter.fragments.mwo oven.ManualModeTemperatureTumblerFragment.
...
class ManualModeTemperatureTumblerFragment : AbstractNumericTumblerFragment(),
    ...
    override fun setCtaLeft() {
        if(getCookingViewModel()?.let {CookingAppUtils.isRecipeOptionAvailable(it.recipeExecutionViewModel, RecipeOptions.DELAY_TIME) } == true) {
    ...
    override fun setHeaderLevel() {
        ...
        getBinding()?.headerBar?.setInfoIconVisibility(checkIfInstructionAvailable)
