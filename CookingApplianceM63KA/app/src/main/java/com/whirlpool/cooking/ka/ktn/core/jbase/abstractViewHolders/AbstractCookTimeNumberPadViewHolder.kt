...
abstract class AbstractCookTimeNumberPadViewHolder {
    // ================================================================================================================
    // -----------------------------------------------  General Methods  ----------------------------------------------
    // ================================================================================================================
    /**
     ...
     */
    abstract fun getBinding(): FragmentCookTimeFieldNumberpadBinding?
     ...
     * @return [KeyboardView]
     */
    abstract fun getLeftPowerConstraint(): ConstraintLayout?
