...
class CustomSlideBottom(private val slideDistance: Float = 200f) : Visibility() {
    ...
    override fun onAppear(
        ...
        // For "enter" transitions, slide in from below
        val endY = 0f
    ...
    override fun onDisappear(
        ...
        // For "exit" transitions, slide out to below
