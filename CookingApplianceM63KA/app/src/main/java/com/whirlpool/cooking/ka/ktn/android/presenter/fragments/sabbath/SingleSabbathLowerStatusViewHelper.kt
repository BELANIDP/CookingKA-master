...
import com.whirlpool.cooking.ka.databinding.SabbathFragmentSingleLowerStatusBinding
import com.whirlpool.hmi.cooking.viewmodel.CookingViewModel
import com.whirlpool.hmi.cooking.viewmodel.CookingViewModelFactory
import core.utils.AppConstants

/**
 * File        : core.viewHolderHelpers.SingleSabbathLowerStatusViewHelper
 * Brief       : Helper class to provide single status binding along with its helpers for Sabbath Bake for Lower Oven
 * Author      : Hiren
 ...
 *               inflate for Double or Combo Variants where lower only lower Oven Cavity has Sabbath Bake recipe RUNNING
 */
class SingleSabbathLowerStatusViewHelper : AbstractStatusViewHelper() {
     private var fragmentSingleStatusBinding: SabbathFragmentSingleLowerStatusBinding? = null
    ...
    override fun onCreateView(
        ...
        fragmentSingleStatusBinding =
            SabbathFragmentSingleLowerStatusBinding.inflate(inflater, container, false)
