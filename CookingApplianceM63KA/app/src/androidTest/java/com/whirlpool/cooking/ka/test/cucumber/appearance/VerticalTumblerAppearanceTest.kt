...
class VerticalTumblerAppearanceTest {
...
//       setFragmentScenario(TestWidgetFragment::class.java)
    ...
    {
//        setFragmentScenario(VerticalTumblerFragment::class.java)
    }
   fun performVerticalTumblerClick()
    {
        UiTestingUtils.sleep(5000)
//        UiTestingUtils.performClick(R.id.button11)
    }
...
//        UiTestingUtils.isViewVisible(R.id.button_2)
    ...
    fun verticalTumblerIsVisible() {
        UiTestingUtils.sleep(5000)
        UiTestingUtils.isViewVisible(R.id.tumblerLeft)
    }

    fun verticalScrollTop(tumblerView: Int)
    {
        UiTestingUtils.scrollToRecyclerViewIndex(tumblerView,0)
    }

    fun verticalScrollBottom(tumblerView: Int)
    {
        UiTestingUtils.scrollToRecyclerViewIndex(tumblerView,10)
    }

    fun checkTumblerHeight(tumblerView:Int): Boolean {
        val expectedHeight = 139
        var isPaddingAsExpected = false

        onView(withId(tumblerView)).check { view, _ ->
    ...
    fun checkTumblerWidth(tumblerView:Int): Boolean {
    ...
    fun checkIsContainerPaddingProper(tumblerView:Int) {
    ...
    fun checkIsContainerPaddingProperNotProper(tumblerView: Int) {
        val expectedPaddingTop = 0
        val expectedPaddingBottom = 0
