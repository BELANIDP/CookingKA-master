Feature: Cooking - Self clean flows for double oven
  Test Self clean related features for the double oven
  ...
  @selfCleanDoubleOven @soilLevel @success
  ...
  @selfCleanDoubleOven @instructions @success
  ...
  @selfCleanDoubleOven @prepareOven @success
...
# ------------------ Prepare Oven Description Appearance ---------------- #
  ...
  @selfCleanDoubleOven @prepareOven @error
  ...
  @selfCleanDoubleOven @doorHasOpenedClosed @success
...
# --------------- Door has opened closed Screen Description Appearance ------------ #
 ...
 # ------------- Door has opened closed Screen DELAY Button Navigation -------------------- #
  ...
  @selfCleanDoubleOven @doorHasOpenedClosed11 @success
 ...
 # ------------------ Door has opened closed Screen Behaviour ---------------- #
  ...
  @selfCleanDoubleOven @doorHasOpenedClosed @error
  ...
  @selfCleanDoubleOven @doorHasntOpenedClosed @success
  ...
  @selfCleanDoubleOven @doorHasntOpenedClosed @error
 ...
 # ------------- Door hasn't opened closed Screen Navigation -------------------- #
  ...
  @selfCleanDoubleOven @lockingOvenDoor @success
...
# --------------- Locking Oven Door Behaviour ------------ #
 ...
 # ======================================================================= #
  ...
  @selfCleanDoubleOven @selfCleanCompleted @success
