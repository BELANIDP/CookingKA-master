Feature: Cooking - Probe for Single oven
  ...
  @probeSingle
  Scenario: Test 9 : Probe detected yes button validation
    Given The app has started with Single low end Variant
  ...
  @probeSingle
  Scenario Outline: Test 10 : Probe removed on status screen pop up validation
    Given The app has started with Single low end Variant
    And I insert a probe in upper cavity
    And I see probe recipe gridview
    And I click on "<recipeName>"
  ...
  @probeSingleProduct
  Scenario: Test 11 : Perform click on clock screen when probe is already inserted.
    Given The app has started with Single low end Variant
    And I perform click on clock screen
    And I see probe recipe gridview

  @probeSingleProduct
  Scenario: Test 12 : Probe recipe selection gridview validation on product
    Given The app has started with Single low end Variant
    And I perform click on clock screen
    And I see probe recipe gridview
    And I check probe recipe selection gridview title text
  ...
  @probeSingleProduct
  Scenario: Test 13 : probe still detected popup validation on product
    Given The app has started with Single low end Variant
    And I perform click on clock screen
    And I see probe recipe gridview
    And I click on back button on Probe recipe Selection screen grid
  ...
  @probeSingleProduct
  Scenario Outline: Test 14 : Probe temp tumbler validation on product
    Given The app has started with Single low end Variant
    And I perform click on clock screen
    And I see probe recipe gridview
    And I click on "<recipeName>"
  ...
  @probeSingleProduct
  Scenario Outline: Test 15 : oven temp tumbler validation on product
    Given The app has started with Single low end Variant
    And I perform click on clock screen
    And I see probe recipe gridview
    And I click on "<recipeName>"
  ...
  @probeSingleProduct
  Scenario Outline: Test 16 : Probe preview screen validation on product
    Given The app has started with Single low end Variant
    And I perform click on clock screen
    And I see probe recipe gridview
    And I click on "<recipeName>"
  ...
  @probeSingleProduct
  Scenario Outline: Test 17 : Probe status screen validation on product
    Given The app has started with Single low end Variant
    And I perform click on clock screen
    And I see probe recipe gridview
    And I click on "<recipeName>"
